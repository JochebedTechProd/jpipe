...
###################Main#################
glb_mqttConnected = False  # global variable for the state of the connection
...
#print "devRegSubTopic=",devRegSubTopic
client.subscribe(devRegSubTopic)
client.loop_forever()
...
while (1):  
    client.loop()
    #client.disconnect()
    if (glb_dataSubscribed==False and glb_lastRecvConfigParms!=None):
        glb_dataSubscribed=True
